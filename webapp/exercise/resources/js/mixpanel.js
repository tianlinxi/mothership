 ...
 */
    ...
    var UserRelated = {
        ...
        registerSP: function(id,name,type){
            mixpanel.register({
                userId:id,
                userName:name,
                userType:type
        ...
        logout: function(){
            mixpanel.track("Logout",null,function(){window.open('/signout','_self')});
        },
...
/*      quitQuiz: function(id,title,time_spent){
    ...
    function initMixpanel(id,name,type){
        UserRelated.identifyId(id,UserRelated.registerSP(id,name,type));
    }
